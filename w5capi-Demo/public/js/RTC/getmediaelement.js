// __________________
// getMediaElement.js
function getMediaElement(mediaElement, config,id) {
    config = config || { };
    if (!mediaElement.nodeName || (mediaElement.nodeName.toLowerCase() != 'audio' && mediaElement.nodeName.toLowerCase() != 'video')) {
		...
		{
		 attachMediaStream(mediaElement,mediaStream);
		}
...
// __________________
// getAudioElement.js
function getAudioElement(mediaElement, config,id) {
    config = config || { };
	...
	console.log( 'mediaelement container',mediaElementContainer.media);
